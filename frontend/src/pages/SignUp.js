            ...
            <div className='bg-white p-5 w-full max-w-sm mx-auto'>
                    ...
                    <form className='pt-6 flex flex-col gap-2' onSubmit={handleSubmit} autoComplete="off">
                      <div className='grid'>
                        ...
                        <button className='bg-violet-600 hover:bg-violet-700 text-white px-6 py-2 w-full max-w-[150px] rounded-full hover:scale-110 transition-all mx-auto block mt-6'>Sign Up</button>
